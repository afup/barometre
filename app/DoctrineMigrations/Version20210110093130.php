...
class Version20210110093130 extends AbstractMigration
{
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE response DROP cmsUsageInProject, DROP covid19CompanyTrust, DROP covid19CompanyHandle, DROP covid19Layoff, DROP covid19FuturePlan, DROP covid19SalaryImpact, DROP covid19PartialUnemployment, DROP covid19RegularRemoteFeeling, DROP covid19RemotePace');
    }
}
